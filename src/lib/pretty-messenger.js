...
export default class PrettyMessenger {
  constructor() {
    ...
    this.sAlertMarkup = '<div class="alert $TYPE$ alert-dismissible fade show animated fadeInRight fast" role="alert">$CONTENT$<button type="button" class="close" data-bs-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
  }
